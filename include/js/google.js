...
document.writeln('<form name="gform" id="gform" method="get" action="http://www.google.com.vn/search?" target="_blank" onSubmit="validate_google(this);">');
...
document.writeln('<option value="0"' + google_default_0 + '>Tìm trên internet</option>');
document.writeln('<option value="1"' + google_default_1 + '>Tìm trên diễn đàn</option>');
document.writeln('</select>');
document.writeln('&nbsp;<button type="submit" name="sa" value="true">Tìm</button>');
